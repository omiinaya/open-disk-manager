...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/openpartitionmanager/opm/tree/main/website/",
          "routeBasePath": "docs"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Open Partition Manager Contributors. Built with Docusaurus. Licensed under GPL-3.0."
    },
    "prism": {
      "theme": {
        "plain": {
